...
fn configuration(comptime cfg: *CfgData) void {
    ...
    cfg.CRE_TSK("TASK1", CTSK(TA_NULL, 1, task1, TASK1_PRIORITY,
                              STACK_SIZE, null));
    cfg.CRE_TSK("TASK2", CTSK(TA_NULL, 2, task2, TASK2_PRIORITY,
                              STACK_SIZE, null));
    cfg.CRE_TSK("TASK3", CTSK(TA_NULL, 3, task3, TASK3_PRIORITY,
                              STACK_SIZE, null));
    cfg.CRE_TSK("TASK4", CTSK(TA_ACT, 4, task4, TASK4_PRIORITY,
                              STACK_SIZE, null));
    cfg.CRE_CYC("CYC1", CCYC(TA_NULL, NFY_TMEHDR(0, cyclic_handler),
