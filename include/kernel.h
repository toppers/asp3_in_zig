 ...
 *  の責任を負わない．
 * 
 *  $Id: kernel.h 1344 2019-12-08 12:21:54Z ertl-hiro $
 */
...
#if defined(SUPPORT_OVRHDR) && defined(TOPPERS_TARGET_SUPPORT_OVRHDR)
#define TOPPERS_SUPPORT_OVRHDR			/* オーバランハンドラ機能拡張 */
#endif /* defined(SUPPORT_OVRHDR) && defined(TOPPERS_TARGET_SUPPORT_OVRHDR) */
